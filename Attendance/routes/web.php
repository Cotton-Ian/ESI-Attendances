...
// PRESENCE
Route::get('/presence/{id}', [PresenceController::class, 'getPresenceToday']) -> name('presence');
...
//LESSONS
Route::get('/lessons', [LessonController::class, 'index']) -> middleware('format.datetime') -> name('lessons') ;
Route::get('/lessons/{id}/presence', [LessonController::class, 'retrieve']) -> name('lessons.presence');
